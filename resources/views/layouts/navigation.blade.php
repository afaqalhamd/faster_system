...
<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        @can('delivery.view')
            <li>
                <a href="javascript:;" class="has-arrow">
                    ...
                    <div class="menu-title">{{
                        __('delivery.delivery') }}</div>
                </a>
                <ul>
                    <li class="{{ request()->is('delivery/dashboard') ? 'mm-active' : '' }}">
                        <a href="{{ route('delivery.dashboard') }}"><i
                                class='bx bx-radio-circle'></i>{{ __('delivery.dashboard') }}</a>
                    </li>
                    <li class="{{ request()->is('delivery/pending') ? 'mm-active' : '' }}">
                        <a href="{{ route('delivery.pending') }}"><i
                                class='bx bx-radio-circle'></i>{{ __('delivery.pending_deliveries') }}</a>
                    </li>
                    <li class="{{ request()->is('delivery/completed') ? 'mm-active' : '' }}">
                        <a href="{{ route('delivery.completed') }}"><i
                                class='bx bx-radio-circle'></i>{{ __('delivery.completed_deliveries') }}</a>
                    </li>
                </ul>
            </li>
        @endcan
                ...
                <ul>
                    @can('item.view')
                        <li class="{{ request()->is('item/list', 'item/create', 'item/edit*', 'item/transaction*') ? 'mm-active' : '' }}">
                            <a href="{{ route('item.list') }}"><i class='bx bx-radio-circle'></i>{{ __('item.list') }}
                            </a>
                        </li>
                        <li class="{{ request()->is('item/damaged-list') ? 'mm-active' : '' }}">
                            <a href="{{ route('item.damaged.list') }}"><i class='bx bx-radio-circle'></i>{{ __('item.damaged_lists') }}
                            </a>
                        </li>
                    @endcan
        ...
        @endcanany
                        ...
                        {{-- @canany(['item.create', 'item.view', 'item.category.create', 'item.category.view'])
                        <li>
                            <a href="javascript:;" class="has-arrow">
                                <div class="parent-icon"><i class="bx bx-package"></i>
                                </div>
                ...
                <ul>
                    ...
                    @can('user.view')
                        <li class="{{ request()->is('users*') ? 'mm-active' : '' }}">
                            <a href="{{ route('users.list') }}"><i class='bx bx-radio-circle'></i>{{ __('user.users') }}
                            </a>
                        </li>
                    @endcan
                    @can('role.view')
                        <li class="{{ request()->is('role-and-permission/role*') ? 'mm-active' : '' }}">
                            <a href="{{ route('roles.list') }}"><i class='bx bx-radio-circle'></i>{{ __('app.roles') }}
                            </a>
                        </li>
                    @endcan
                </ul>
                ...
                @canany(['company.edit'])
                    <ul>
                        <li class="{{ request()->is('company') ? 'mm-active' : '' }}">
                            <a href="{{ route('company') }}"><i class='bx bx-radio-circle'></i>{{ __('app.company') }}
                            </a>
                        </li>
                    </ul>
                @endcanany
                ...
                @canany(['unit.view'])
                    <ul>
                        <li class="{{ request()->is('unit*') ? 'mm-active' : '' }}">
                            <a href="{{ route('unit.list') }}"><i class='bx bx-radio-circle'></i>{{ __('unit.list') }}
                            </a>
                        </li>
                    </ul>
                @endcanany
