@extends('layouts.app')
@section('title', __('payment.payment_out'))
        ...
        <div class="page-wrapper">
            <div class="page-content">
                    ...
                    <div class="card-header px-4 py-3 d-flex justify-content-between">
                        ...
                        <div>
                            <h5 class="mb-0 text-uppercase">{{ __('payment.payment_out') }}</h5>
                        </div>
...
<script src="{{ versionedAsset('custom/js/purchase/purchase-bill-payment-list.js') }}"></script>
@endsection
