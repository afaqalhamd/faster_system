...
@section('title', __('sale.return.return'))
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="row">
                    <form class="g-3 needs-validation" id="invoiceForm" action="{{ route('sale.return.store') }}" enctype="multipart/form-data">
                        {{-- CSRF Protection --}}
                        @csrf
                        @method('POST')
                            ...
                            <div class="col-12 col-lg-12">
                                <div class="card">
                                    <div class="card-header px-4 py-3">
                                        <h5 class="mb-0">{{ __('sale.return.details') }}</h5>
                                    </div>
                                    <div class="card-body p-4 row g-3">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    <x-input type="text" additionalClasses="datepicker" name="return_date" :required="true" value=""/>
