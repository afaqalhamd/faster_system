...
@section('title', __('sale.invoice'))
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="row">
                    <form class="g-3 needs-validation" id="invoiceForm" action="{{ ($sale->operation == 'convert') ?  route('sale-order.to.sale.save') : route('sale.invoice.update') }}" enctype="multipart/form-data">
                        {{-- CSRF Protection --}}
                        @csrf

                        {{-- Holds PUT method if Edit operation, else holds POST if Sale Order converting to Sale --}}
                        @if($sale->operation == 'convert')
                            @method('POST')
                        @else
                            @method('PUT')
                        @endif

                        {{-- Hold Sale Id if Edit operation, Sale Order Id if Sale Order converting to Sale --}}
                        @if($sale->operation == 'convert')
                            @if($sale->converting_from == 'Sale Order')
                                <input type="hidden" name="sale_order_id" value="{{ $sale->id }}">
                            @else
                                <input type="hidden" name="quotation_id" value="{{ $sale->id }}">
                            @endif
                            <input type="hidden" name="converting_from" value="{{ $sale->converting_from }}">
                        @else
                        ...
                        <input type="hidden" id="operation" name="operation" value="{{ $sale->operation }}">
                            ...
                            <div class="col-12 col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body p-4 row g-3">
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-select party-ajax" data-party-type='customer' data-placeholder="Select Customer" id="party_id" name="party_id">
                                                        <option value="{{ $sale->party->id }}">{{ $sale->party->getFullName() }}</option>
                                                    </select>
                                            ...
                                            <div class="col-md-4">
                                                <x-label for="sale_date" name="{{ __('app.date') }}" />
                                                <div class="input-group mb-3">
                                                    <x-input type="text" additionalClasses="datepicker-edit" name="sale_date" :required="true" value="{{ $sale->formatted_sale_date }}"/>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    <x-dropdown-currency selected="{{ $sale->currency_id }}" name='invoice_currency_id'/>
                                                    <x-input type="text" name="exchange_rate" :required="false" additionalClasses='cu_numeric' value="{{ $sale->exchange_rate }}"/>
                                                </div>
                                            </div>
                                            @endif
                                    ...
                                    <div class="card-body p-4 row g-3">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <x-textarea name='note' value='{{ $sale->note }}'/>
                                            </div>
                                                ...
                                                <table class="table mb-0 table-striped">
                                                   <tbody>
                                                      ...
                                                      <tr>
                                                         ...
                                                         <td>
                                                            <x-input type="text" additionalClasses="text-end paid_amount" readonly=true :required="false" placeholder="Paid Amount" value="{{ $formatNumber->formatWithPrecision($sale->paid_amount, comma:false) }}"/>
                                                        </td>
                                                      </tr>
                                                      <tr>
