@extends('layouts.app')
@section('title', __('sale.order.list'))
        ...
        <div class="page-wrapper">
            <div class="page-content">
                    ...
                    <div class="card-header px-4 py-3 d-flex justify-content-between">
                        ...
                        <div>
                            <h5 class="mb-0 text-uppercase">{{ __('sale.order.list') }}</h5>
                        </div>

                        <div class="d-flex gap-2">
                            @can('sale.order.import')
                            <a href="{{ route('import.sale') }}" class="btn btn-outline-primary px-5"><i class="bx bx-import me-1"></i> {{ __("app.import_sales") }}</a>
                            @endcan
...
{{--                            <x-anchor-tag href="{{ route('sale.order.create') }}" text="{{ __('sale.order.create') }}" class="btn btn-primary px-5" />--}}
        ...
        @include("modals.status-history.view", ['history_of' => 'sale-order' ])
