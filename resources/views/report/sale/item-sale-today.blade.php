@extends('layouts.app')
@section('title', __('sale.sale_report_today'))
        ...
        <div class="page-wrapper">
            <div class="page-content">
                <x-breadcrumb :langArray="[
                                            'app.reports',
                                            'sale.sale_report_today',
                                        ]"/>
                <div class="row">
                    <form class="row g-3 needs-validation" id="reportForm" action="{{ route('report.sale.item.today.ajax') }}" enctype="multipart/form-data">
                        {{-- CSRF Protection --}}
                        @csrf
                        @method('POST')
                        ...
                        <div class="col-12 col-lg-12">
                            <div class="card">
                                <div class="card-header px-4 py-3">
                                    <h5 class="mb-0">{{ __('sale.sale_report_today') }}</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-lg-12">
