@extends('layouts.app')
@section('title', __('item.damaged_list'))
        ...
        <div class="page-content">
            ...
            <div class="card">
                ...
                <div class="card-header px-4 py-3 d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <h5 class="mb-0 text-uppercase">{{ __('item.damaged_list') }}</h5>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select single-select-clear-field" id="tracking_type"
                                    name="tracking_type" data-placeholder="Choose one thing">
                                <option></option>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content bg-transparent border-0">
            <div class="modal-body text-center p-0">
                <img id="modalImage" src="" alt="" class="img-fluid" style="max-height: 80vh; cursor: pointer;"
                     onclick="$('#imageModal').modal('hide')">
            </div>
        </div>
    </div>
</div>
@section('js')
    ...
    <script src="{{ versionedAsset('custom/js/items/damaged-item-list.js') }}"></script>
    <script>
        ...
        // Function to close the modal when clicking on the image
        function closeModal() {
