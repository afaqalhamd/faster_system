...
@section('title', __('item.import_items'))
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="row">
                    <form class="row g-3 needs-validation" id="importForm" action="{{ route('import.purchase.upload') }}" enctype="multipart/form-data">
                        {{-- CSRF Protection --}}
                        @csrf
                        @method('POST')
                        ...
                        <div class="col-12 col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-header px-4 py-3">
                                    <h5 class="mb-0">{{ __('app.import_purchase') }}</h5>
                                </div>
                                <div class="card-body p-4 row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <x-label for="download_sample" name="{{ __('app.download_sample') }}" /><br>
                                             <a href="{{ route('download-purchase-sheet') }}" class="btn btn-outline-primary px-5 radius-0" download>Download</a>
                                        </div>
                                        <div class="col-md-6">
...
@section('js')
    ...
    <script src="{{ versionedAsset('custom/js/import/purchase.js') }}"></script>
