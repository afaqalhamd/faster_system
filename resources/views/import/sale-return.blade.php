...
@section('title', __('item.import_items'))
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="row">
                    <form class="row g-3 needs-validation" id="importForm" action="{{ route('import.sale-return.upload') }}" enctype="multipart/form-data">
                        {{-- CSRF Protection --}}
                        @csrf
                        @method('POST')
                                ...
                                <div class="card-body p-4 row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <x-label for="download_sample" name="{{ __('app.download_sample') }}" /><br>
                                             <a href="{{ route('download-sale-return-sheet') }}" class="btn btn-outline-primary px-5 radius-0" download>Download</a>
                                        </div>
                                        <div class="col-md-6">
