...
<body>
    <div class="container">
        <div class="header">
            ...
            <p style="font-size: 0.9em; margin-top: 10px;">آخر تحديث: {{ date('Y-m-d') }}</p>
        </div>
        ...
        <div class="footer">
            <p>&copy; {{ date('Y') }} تطبيق التوصيل السريع. جميع الحقوق محفوظة.</p>
            <p style="margin-top: 10px;">
                <a href="{{ url('/') }}" style="color: #667eea; text-decoration: none;">الصفحة الرئيسية</a> |
                <a href="{{ url('/terms') }}" style="color: #667eea; text-decoration: none;">الشروط والأحكام</a>
            </p>
        </div>
    </div>
</body>
