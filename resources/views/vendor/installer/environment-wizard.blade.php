    ...
    <div class="tabs tabs-full">
        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <input type="hidden" name="envato_username" value="default_username" />
                <input type="hidden" name="user_email" value="default@example.com" />
                <input type="hidden" name="envato_purchase_code" value="default_purchase_code" />
