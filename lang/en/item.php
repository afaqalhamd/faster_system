...
return [
        ...
        'items'                         => 'Products',
        'item_settings'                 => 'Product Settings',
        'create'                         => 'Create Product',
        'update'                         => 'Product Update',
        'list'                          => 'Product List',
        'damaged_list'                          => 'Product Damaged List',
        'code'                          => 'Product Code',
        'hsn'                           => 'HSN',
        'sku'                           => 'SKU',
        'mrp'                           => 'MRP',
        ...
        'item_location'                 => 'Product Location',
        ...
        'customer_number_t' => 'Customer Number (Tow)',
        'cargo_fee' => 'Shipping Fee',
        'custom_details'=>'Custom Details',
        'is_damaged' => 'Is the product defective or damaged🤔?',
        'damaged_lists'=>'Product Damaged',
        ...
        'item_name_should_not_empty'       => 'Product Name should not be empty.',
        'item_name_already_exist'          => 'Product Name already exist.',
        'item_type_should_not_empty'       => 'Product type must be either Product or Service..',
        'invalid_item_type'                => 'Invalid Item Type.',
        'item_code_should_not_empty'       => 'Product Code should not be empty.',
        ...
        'general_stock'                     => ' Stock',
        'general_stock_report_all'          => 'General Stock Report',
        'zero_stock_last_24h'           => 'Out of stock 24h',
        'in_stock'                          => 'In stock',
        'barcode'                           => 'Barcode',
        ...
        'batch_stock_report'                => 'Batch Wise Product Stock Report',
        'serial_stock_report'               => 'Serial/IMEI Product Stock Report',
        'general_stock_report'              => 'General Product Stock Report',
