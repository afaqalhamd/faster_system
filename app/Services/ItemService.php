...
class ItemService{
    ...
    public function getQuantityInUnit(float $quantity, int $itemId): string
    {
        ...
        if ($baseUnitQuantity > 0) {
            $formattedQuantity .= "{$baseUnitQuantity} {$baseUnitName}";
        }
        ...
        if ($secondaryUnitQuantity > 0) {
            ...
            $formattedQuantity .= "{$secondaryUnitQuantity} {$secondaryUnitName}";
        }
        ...
        return $negativeIndicator . ($formattedQuantity ?: '0 ' . $baseUnitName);
    }
