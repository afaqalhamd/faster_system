...
class SaleReturnOrderController extends Controller
{
    use FormatNumber;
    ...
    {
        return view('sale.return.order.list');
    }
    ...
    public function edit($id): View
    {
        ...
        $itemTransactions = $order->itemTransaction->map(function ($transaction) use ($allUnits) {
            ...
            $itemData['quantity'] = $this->cleanNumber($itemData['quantity']);
        ...
        return view('sale.return.order.edit', compact('taxList', 'order', 'itemTransactionsJson', 'selectedPaymentTypesArray', 'paymentHistory'));
    }

    function cleanNumber($number) {
        return (intval($number) == $number) ? intval($number) : $number;
    }
    ...
    public function details($id): View
    {
        ...
        return view('sale.return.order.details', compact('order', 'selectedPaymentTypesArray', 'batchTrackingRowCount'));
    }
