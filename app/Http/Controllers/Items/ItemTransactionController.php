...
class ItemTransactionController extends Controller
{
    ...
    public function datatableList(Request $request){
        try {
            $data = ItemTransaction::with(['unit', 'transaction'])->where('item_id', $request->item_id);
            ...
            return DataTables::of($data)
                        ...
                        ->addColumn('reference_no', function ($row) {
                            return $row->transaction ? $row->transaction->getTableCode() : '';
                        })
            ...
            \Log::error('ItemTransaction DataTable Error: ' . $e->getMessage());
