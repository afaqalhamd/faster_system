...
class ItemController extends Controller
{
    ...
    public function damagedList(): View
    {
        return view('items.item.damaged-list');
    }
    ...
    public function datatableDamagedList(Request $request)
    {
        $warehouseId = request('warehouse_id');
        $data = Item::with(['tax', 'itemGeneralQuantities', 'brand', 'category'])
            ->when($request->item_category_id, function ($query) use ($request) {
